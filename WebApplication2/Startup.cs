...
using TestTask.BusinessLogic.Repositories;
using TestTask.BusinessLogic.Services;
using TestTask.WebAPI.Swagger;
...
namespace TestTask.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRepository<Book>, InMemoryRepository>();
        }
